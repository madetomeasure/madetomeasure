...
* Update the connection parameters for the database in the `madetomeasure-api.db.schema` namespace of your application.
...
Request middleware functions are located under the `madetomeasure-api.middleware` namespace.
